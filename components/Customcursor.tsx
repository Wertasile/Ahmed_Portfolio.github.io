  ...
  return (
    <>
      ...
      <div
        ...
        ref={cursorRef}
        className={`p-0 fixed pointer-events-none transition-all -translate-x-1/2 -translate-y-1/2 z-50 ease-in duration-300 rounded-full w-8 h-8 border-2 border-${cursorColor} `}
      >
        <div
