...
const Uppermenu = () => {
  ...
  return (
    ...
    <div className="flex p-5 g-5 sm:p-5 justify-between h-18 font-inter">
        <Link className='font-doto text-3xl' href="/" >Ahmed Portfolio </Link>
        <div className='hidden sm:flex sm:justify-between md:w-2/3 lg:w-1/3 text-xl'>
          <Link className="uppermenu-item" href="/">HOME</Link>
          <Link className="uppermenu-item" href="/about">ABOUT ME</Link>
          <Link className="uppermenu-item" href="/work">PROJECTS</Link>
    ...
    <div className='fixed items-end'>
        ...
        {modal ? 
          (<div className=' flex flex-col items-end justify-center w-screen p-2 relative z-10'>
